$(function () {
    ...
    //drugi arguement -> $('.singleBook').find('h3') (tytuł ksiązki)
    //event będzie działał tylko na podanych w drugim argumencie elementach
    //(czyli tylko kiedy NA NIE klikniemy)
    ...
    $('#bookList').on('click', $('.bookTitle'), function (e) {
        ...
        var bookTitle = $(e.target);
        var desc = bookTitle.closest('.singleBook').find('.description');
        
        //pobieram id książki, w którą klikam
        var bookId = bookTitle.parent().attr('data-id');
